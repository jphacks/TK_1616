...
var SpeechRec=window.SpeechRec={};SpeechRec._client_version="speechrec.js-1.3.3.0";SpeechRec.BASE_URL="wss://speechrec.skyway.io/recognize";SpeechRec.SRP_H5_URL="wss:/speechrec.skyway.io/recognize";SpeechRec.USER_AGENT="SpeechRecClientWS/1.0";SpeechRec.SKYWAY_URL="https://skyway.io/ds/speechrec/token/";
SpeechRec.DEFAULT_CONFIG={SkyWayKey:"",ApiKey:"",OpusWorkerUrl:"libopus.worker.js",NrFlag:!0,SbmMode:2,"Recg:Nbest":0,mic_recorder_port:2001,buffer_size_as_seconds:60,"SRL:UserDefine":"",TooLongAbort:!1,ContinuousMode:!1};SpeechRec.is_little_endian=!!(new Uint8Array((new Uint16Array([1])).buffer))[0];
navigator.getUserMedia?SpeechRec.user_media="getUserMedia":navigator.webkitGetUserMedia?(navigator.getUserMedia=navigator.webkitGetUserMedia,SpeechRec.user_media="webkitGetUserMedia"):navigator.mozGetUserMedia?(navigator.getUserMedia=navigator.mozGetUserMedia,SpeechRec.user_media="mozGetUserMedia"):SpeechRec.user_media="";window.AudioContext||(window.webkitAudioContext?window.AudioContext=window.webkitAudioContext:window.mozAudioContext&&(window.AudioContext=window.mozAudioContext));
SpeechRec.is_chrome=function(){return navigator.getUserMedia?!0:!1};SpeechRec._availability_message="-";SpeechRec.availability_message=function(){return SpeechRec._availability_message};
